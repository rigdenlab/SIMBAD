...
class Phaser(object):
    ...
    def __init__(self, enant, f, hklin, hklout, logfile, pdbin, pdbout, sigf, solvent, timeout, work_dir):
        self._enant = None
        self._f = None
        self._hklin = None
        self._hklout = None
    ...
    def run(self):
        ...
        key = key.format(self.timeout, hklin, self.f, self.sigf, sgalternative, pdbin, self.solvent)
...
if __name__ == "__main__":
    ...
    phaser = Phaser(args.enant, args.f, args.hklin, args.hklout, args.logfile, 
                    args.pdbin, args.pdbout, args.sigf, args.solvent, args.timeout, args.work_dir)
    phaser.run()
