...
class Test(unittest.TestCase):
    ...
    def test_rotsearch_parser(self):
        """Test case for simbad.parsers.rotsearch_parser.RotsearchParser.parse"""
        
        # Make tmp file containing key lines from ROTSEARCH log
