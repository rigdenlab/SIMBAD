...
class LatticeSearchResult(ScoreBase):
    ...
    def __init__(self, pdb_code, pdb_path, alt, unit_cell, volume_difference, total_penalty, length_penalty, angle_penalty, probability_score):
    ...
    def __repr__(self):
        template = (
            "{name}(pdb_code={pdb_code} pdb_path={pdb_path} alt={alt} unit_cell={unit_cell} "
