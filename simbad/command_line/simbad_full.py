...
def main():
    ...
    while not (solution_found or end_of_cycle):
        ...
        logger.info(
            "Lattice search completed in %d days, %d hours, %d minutes, and %d seconds", *stopwatch.lap.time_pretty
        )
        ...
        logger.info(
            "Contaminant search completed in %d days, %d hours, %d minutes, and %d seconds", *stopwatch.lap.time_pretty
        )
        ...
        if solution_found and not args.process_all:
            ...
            logger.info("SIMBAD thinks it has found a solution however process_all is set, continuing to morda search")
        else:
        ...
        logger.info(
            "Full MoRDa domain search completed in %d days, %d hours, %d minutes, and %d seconds",
