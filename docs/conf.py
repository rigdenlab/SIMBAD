...
author = "Adam Simpkin, Ronan Keegan, Felix Simkovic & Daniel Rigden"
...
html_context = {
    ...
    "github_url": "https://github.com/rigdenlab/simbad.git"
}
...
html_title = "SIMBAD v{0}".format(version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "SIMBAD"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "_static/logo_simbad.svg"
...
man_pages = [(master_doc, "simbad", "SIMBAD Documentation", [author], 1)]
